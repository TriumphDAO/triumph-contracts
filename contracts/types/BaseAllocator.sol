...
// types
import "../types/TriumphAccessControlledV2.sol";
 ...
 */
abstract contract BaseAllocator is TriumphAccessControlledV2, IAllocator {
    ...
    constructor(AllocatorInitData memory data) TriumphAccessControlledV2(data.authority) {
        _tokens = data.tokens;
